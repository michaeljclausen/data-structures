describe('doublyLinkedList', function() {
  ...
  it('should have designate a single node as head and tail when added to the tail', function() {
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.head.value).to.equal(5);
    expect(doublyLinkedList.tail.value).to.equal(5);
  });

  it('should have designate a single node as head and tail when added to the head', function() {
